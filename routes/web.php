...
Route::group(['middleware' => 'admin_guard', 'prefix' => 'admin'], function () {
    ...
    Route::get('/users/register', [UserController::class, 'registerForm'])->name('users.register');
    ...
    Route::post('/users/update/{id}', [UserController::class, 'admin_user_update'])->name('admin_user_update');
