...
class TicketController extends Controller
{
    ...
    public function updateStatus($id, Request $request)
    {
        ...
        // If the user is authorized in any of the tables, update the ticket status to 'Validé'
        if ($authorizedUser || $authorizedOrganizer || $authorizedAdmin) {
            ...
            // Redirect back or return an error response if the user is not authorized
