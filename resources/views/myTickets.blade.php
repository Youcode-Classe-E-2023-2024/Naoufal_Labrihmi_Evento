                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <br>
                                        <!-- Display a form to change the validation status only if the user type is not 'U' -->
                                        @if (auth()->user()->user_type != 'U')
                                        <form method="POST" action="{{ route('updateValidation', ['id' => $ticket->buy_ticket_id]) }}">
                                            @csrf
                                            @method('PUT')
                ...
                <div class="container-fluid">
                    ...
                    <div class="col-12 mb-3">
                        <p><strong>Total Tickets: </strong> <span id="totalTickets"></span> <br>
                            <strong>Remaining Tickets: </strong> <span id="remainingTickets"></span>
                        </p>
                    </div>
                    <div class="col-12 mb-3">
