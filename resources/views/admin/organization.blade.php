            ...
            <div class="white_shd full margin_bottom_30">
                <div class="full graph_head">
                    ...
                    <div class="heading1 margin_0 d-flex justify-content-between mt-3 mb-4">
                        ...
                        <a href="{{ route('admin.register') }}" class="btn btn-primary">Add Organization+</a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{url('admin/organizations/delete')}}/{{$user->id}}" class="btn btn-danger m-1 deleteBtn "><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                                @php
                                $i++;
                    ...
                    <div class="container-fluid">
                        <form action="{{route('admin.users')}}" method="post" id="form">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" name="password" id="password" aria-describedby="helpId" placeholder="Enter Your Passwrord">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" name="password_confirmation" id="password_confirmation" aria-describedby="helpId" placeholder="Confirm Passwrord">
                    ...
                    <div class="container-fluid">
                        <form action="{{route('admin.users')}}" method="post" id="updateform">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="editname" id="editname" aria-describedby="helpId" placeholder="">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" name="editemail" id="editemail" aria-describedby="helpId" placeholder="">
                            ...
                            <div class="mb-3">
                                <label for="contact" class="form-label">Contact</label>
                                <input type="text" class="form-control" name="editcontact" id="editcontact" aria-describedby="helpId" placeholder="">
                            ...
                            <div class="mb-3">
                                <label for="address" class="form-label">Home/Shop Address</label>
                                <input type="text" class="form-control" name="editaddress" id="editaddress" aria-describedby="helpId" placeholder="Enter Your Address">
